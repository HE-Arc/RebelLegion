...
@section('content')
				...
				<div class="row">
					<div class="small-centered small-12 medium-8 large-6 columns game_info_desc">
						...
						<div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit>
						  <ul class="orbit-container">
						    ...
						    <li class="is-active orbit-slide">
						      <div>
						        <h3 class="text-center">0 You can also throw some text in here!</h3>
